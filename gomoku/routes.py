...
@app.route("/room/<int:room_number>/<int:player_number>", methods=["GET", "POST"])
...
@app.route("/drop_a_piece/<int:room_number>/<int:player_number>/<int:row>/<int:column>", methods=["POST"])
